...
//console.log(app.nutil.inspect(req.user, {showHidden: false, depth: null}));
exports = module.exports = function(app, passport) {

	app.get('/', require('./controllers/index').init );

  //login  passport.authenticate('local'), function(req, res) {    res.redirect('/'); }
	app.get('/login', require('./controllers/passport/login').init  );
	app.post('/login', require('./controllers/passport/login').login );

  //register
  app.get('/register', require('./controllers/passport/register').init );
  app.post('/register',require('./controllers/passport/register').register );

	//logout
	app.get('/logout', require('./controllers/passport/logout').init);

  //forgot password
  app.get('/forgot-password',  require('./controllers/passport/forgotpassword').init);
  app.post('/forgot-password',  require('./controllers/passport/forgotpassword').post);

  //admin
  app.all('/admin*', ensureAuthenticated);
  //app.all('/admin*', ensureAdmin);

  app.get('/admin/menu', require('./controllers/admin/menu').init );
